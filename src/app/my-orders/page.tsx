...
export default function MyOrdersPage() {
  ...
  const getStatusLabel = (status: string) => {
    ...
    if (s === "packed") return { text: "Packed", class: "bg-cyan-50 text-cyan-700 border-cyan-200" };
    if (s === "confirmed") return { text: "Confirmed", class: "bg-indigo-50 text-indigo-700 border-indigo-200" };
    if (s === "cancelled") return { text: "Cancelled", class: "bg-red-50 text-red-700 border-red-200" };
